...
const WhoWeAre = () => {
  return (
    <div className="flex flex-col font-sans items-center justify-center bg-sky-950 text-white py-20 px-6">
      <h2 className="text-5xl font-bold pt-5 mb-4">Who We Are</h2>
      <h3 className="text-2xl font-semibold mb-2">Consulting Firm Powered by Analytics!</h3>
      <p className="italic font-medium text-2xl mb-8">
        We support leaders to EVOLVE their organizations using our proven analytics consulting services.
      </p>
      <p className="text-center mt-5 text-2xl leading-9 max-w-8xl mb-8">
  ...
  <button className="bg-gradient-to-r text-lg from-blue-900 to-blue-500 text-white border border-blue-800 px-8 py-4 rounded-md hover:bg-gradient-to-l hover:from-blue-500 hover:to-blue-800 duration-800 flex items-center transform transition-transform hover:scale-105">
    KNOW MORE
